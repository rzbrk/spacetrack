...
# @attr.s(slots=True)
# class RateLimitedRequest(Event):
#     request = attr.ib()
#     stream = attr.ib(default=False)
...
class SpaceTrackClient:
    ...
    def _auth_generator(self):
        if not self._authenticated:
            ...
            resp = yield NormalRequest(self.client.build_request(
                'POST', 'ajaxauth/login', data=data
            ))
    ...
    def generic_request(
        ...
        **kwargs,
        ...
        """
        return self._run_event_generator(self._generic_request_generator(
            class_=class_,
