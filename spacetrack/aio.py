...
from .base import (
    BASE_URL, Event, IterContent, IterLines, NormalRequest,
    RateLimitWait, ReadResponse, SpaceTrackClient, logger)
...
class AsyncSpaceTrackClient(SpaceTrackClient):
    ...
    async def generic_request(
        ...
        **kwargs,
        ...
        """
        return await self._run_event_generator(self._generic_request_generator(
            class_=class_,
    ...
    async def get_predicates(self, class_, controller=None):
        ...
        """
        return await self._run_event_generator(self._get_predicates_generator(class_, controller))
